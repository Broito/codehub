...
sheet = workbook.add_sheet("clusteraltime", cell_overwrite_ok=True)
...
#     col+=1
sheet.write(0,1,'density18_22')
sheet.write(0,2,'density22_2')
sheet.write(0,3,'density2_6')
rowID=1
searchFiled= ["ToCumul_Length","newoid"]
searchFiled.extend(['acci18_22','acci22_2','acci2_6'])
acciFiled = ['acci18_22','acci22_2','acci2_6']
...
curCenter = sorted(arcpy.da.SearchCursor(centerRoad, ["SHAPE@", "newoid"],"""[newoid] >1610 AND [newoid]<2300"""), key=lambda a_list: a_list[1])  # 搜索道路中心点数据
for point in curCenter:
    ...
    del curJoin
    print point[1]
    workbook.save("E:\\FloatVehicle2019\\clusteralltime.xls")  # 保存数据
    # except:
