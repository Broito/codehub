...
#     col+=1
sheet.write(0,1,'density_pedes_6_18')
sheet.write(0,2,'density_pedes_18_6')
sheet.write(0,3,'density_pedes_7_9')
sheet.write(0,4,'density_pedes_17_19')
rowID=1
searchFiled= ["ToCumul_Length","newoid"]
searchFiled.extend(['pedes6_18','pedes18_6','pedes7_9','pedes17_19'])
acciFiled = ['pedes6_18','pedes18_6','pedes7_9','pedes17_19']
# searchFiled.extend(['pedestrain'])
# acciFiled = ['pedestrain']

arcpy.CheckOutExtension("Network")
networkND = "network\\network_ND"#�������ݼ�
centerRoad = "center_road_pedestrain_4p"#���ĵ�����
seardis = 500 #��ʵ�������뾶
bandWidth = "500"  # �ڷ����������85�������뾶�൱��100��
curCenter = sorted(arcpy.da.SearchCursor(centerRoad, ["SHAPE@", "newoid"],"""[newoid] >1645 AND [newoid]<2300"""), key=lambda a_list: a_list[1])  # ������·���ĵ�����
for point in curCenter:
    try:
        ...
        del curJoin
        print point[1]
        workbook.save(r"E:\FloatVehicle2019\speed_distribution\200m_result\200m_pedestrain_NKDE\cluster_pedestrain_500.xls")  # ��������
    except:
