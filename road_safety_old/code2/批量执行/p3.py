...
def search_road():
    ...
    arcpy.JoinField_management(neartable, "IN_FID", newpoint, "OBJECTID",
                               ["angle", "Field2", "Field7", "Field8", "distance"])  # Field8是GPS点航向角
...
def calculate_angle():
    ...
    arcpy.CalculateField_management(neartable, "road_score", "cal_score( !road_score! )", "PYTHON_9.3",
                                    "def cal_score(score):\\n  if score is None:\\n    return 10000\\n  else:\\n    return score\\n")
