...
def excel_table():
    "0_3小时段excel转换成table，速度有m/s转换成km/h"
    excelPath="F:\\trafficdata\\speed\\speed22_4.xls"#
...
def speed_avg():
    ...
    fieldList=["roadgrade","roadSpeed22_4"]
    sheet.write(0, 0,"roadgrade")
    sheet.write(0,1, "roadSpeed22_4")
...
def speed_all():
    ...
    fieldList=["roadgrade","roadSpeed22_4"]#["roadgrade","roadSpeed0_1"...]
