...
#     col+=1
sheet.write(0,1,'density_vehicle_6_18')
sheet.write(0,2,'density_vehicle_18_6')
sheet.write(0,3,'density_vehicle_7_9')
sheet.write(0,4,'density_vehicle_17_19')
rowID=1
searchFiled= ["ToCumul_Length","newoid"]
searchFiled.extend(['vehicle6_18','vehicle18_6','vehicle7_9','vehicle17_19'])
acciFiled = ['vehicle6_18','vehicle18_6','vehicle7_9','vehicle17_19']
# searchFiled.extend(['pedestrain'])
# acciFiled = ['pedestrain']

arcpy.CheckOutExtension("Network")
networkND = "network\\network_ND"#�������ݼ�
centerRoad = "center_road_vehicle_4p"#���ĵ�����
seardis = 500 #��ʵ�������뾶
bandWidth = "500"  # �ڷ����������85�������뾶�൱��100��
curCenter = sorted(arcpy.da.SearchCursor(centerRoad, ["SHAPE@", "newoid"],"""[newoid] > 1969 AND [newoid]<2300"""), key=lambda a_list: a_list[1])  # ������·���ĵ�����
for point in curCenter:
    ...
    del curJoin
    print point[1]
    workbook.save(r"E:\FloatVehicle2019\speed_distribution\200m_result\200m_vehicle_NKDE\cluster_vehicle_500.xls")  # ��������
    # except:
