...
def strategy_decide(strategy,threshold_pop,threshold_ntl,threshold_combo,current_pop,current_ntl,current_combo):
...
for i in lst_df:
    ...
    for strategy in strategy_list:
        ...
        while True:
            ...
            decide = strategy_decide(strategy,threshold_pop,threshold_ntl,threshold_combo,current_pop,current_ntl,current_combo)
            if decide:
                ...
                df.loc[code6,strategy] = radius-15
