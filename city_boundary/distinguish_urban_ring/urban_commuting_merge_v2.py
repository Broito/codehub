...
env.workspace = r'E:\workspace\Research_2022_city_boundary\commuting_buffer_merge\temp_workspace'
env.overwriteOutput = True

# core_shp = r'E:\workspace\Research_2022_city_boundary\distinguish_ring\result_one\China_urban_v3_2010_no_hole.shp'
shps = ListFeatureClasses()
for core_shp in shps:
    name = core_shp.split('_')[0]
    ...
    result = r'E:\\workspace\\Research_2022_city_boundary\\commuting_buffer_merge\\result_folder\\' + f'{name}_urban_commuting_merged.shp'
