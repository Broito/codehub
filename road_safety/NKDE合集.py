...
#     "在道路上每隔10米生成一个点"
# env.workspace = r"E:\workspace\Research_2021_weather_collision\data_processing\cluster.mdb"
# curline=arcpy.da.SearchCursor("road_OSM_sim200",["SHAPE@",'roadid_sim','pedestrain1415','vehicle1415'])
...
# curpoint=arcpy.da.InsertCursor("center_road",["SHAPE@",'roadid','pedestrain1415','vehicle1415','newoid'])
# for row in curline:
#     line=row[0]
#     roadid = row[1]
...
#     curpoint.insertRow([pt,roadid,row[2],row[3],roadid])
...
sheet.write(0,2,'density_vehicle')
...
searchFiled.extend(['pedestrain1415','vehicle1415'])
acciFiled = ['pedestrain1415','vehicle1415']
...
curCenter = sorted(arcpy.da.SearchCursor(centerRoad, ["SHAPE@", "newoid"],"""[newoid] >524 AND [newoid]<526"""), key=lambda a_list: a_list[1])  # 搜索道路中心点数据
for point in curCenter:
    try:
        ...
        del curJoin
        print(point[1])
        workbook.save(r"E:\workspace\Research_2021_weather_collision\data_processing\NKDE_1415.xls")  # 保存数据
    except:
